...
class DetailViewController: UITableViewController, Notifier, LoadingIndicator {
    ...
    @IBAction func updateEntity(_ sender: AnyObject) {
        ...
        self.myPrefixMyServiceClass.service.updateEntity(self.tableDelegate.entity) { error in
            self.hideIndicator()
    ...
    func createEntity() {
        ...
        self.myPrefixMyServiceClass.service.createEntity(self.tableDelegate.entity) { error in
            self.hideIndicator()
